	...
	<center>
		...
		<a href="yourorder.jsp"><i class="fa fa-first-order"></i> Orders</a> 
			...
			<a href="youraddress.jsp"><i class="fa fa-address-card"></i> Addresses</a>
			 ...
			 <a class="active" href="yourprofile.jsp"><i class="fa fa-user"></i> Profile</a> <a
...
<a href='logout.jsp'>Log out</a>
			...
			String email=myCookie.getValue().toString();
				...
				if (Conn != null) {
					try {
						ps = Conn.prepareStatement("select * from regs where email='" + email + "'");
						ResultSet rs = ps.executeQuery();

						while (rs.next()) {
							out.print("Your details>>>>" + "<br><br>");
							out.print("Your Name: " + "&nbsp;&nbsp;" + rs.getString("fname").toString() + " ");
							out.print(rs.getString("lname").toString() + "<br>");
							out.print("You are : " + "&nbsp;&nbsp;" + rs.getString("gender").toString() + "<br>");
							out.print("Your Phone No.: " + "&nbsp;&nbsp;" + rs.getString("phone").toString() + "<br>");
							out.print("Your Email: " + "&nbsp;&nbsp;" + rs.getString("email").toString() + "<br><br>");
			%>

			<a href="updateuserown.jsp?email=<%=rs.getString("email")%>">EDIT
				YOUR PROFILE</a>
