...
<div class="ri">
		<%out.print("Product's Name: " + "&nbsp;&nbsp;" +rs.getString("p_name").toString()+"<br>");
					out.print("Product's Price: Rs." + "&nbsp;&nbsp;" +rs.getString("p_price").toString()+"<br>");
...
<textarea  readonly style=" resize: none; "><%=rs.getString("p_details") %>
					...
					out.println("Select Size:"+"&nbsp;&nbsp;");
					
					out.print("<form name=\"form-name\" action=\"myCart.jsp\" method=\"post\">");
					...
					if(c.equals("1")){%>
					<a href="customproduct.jsp?p_id=<%=rs.getString("p_id")%>"><input type="button" name="p_size" value="CUSTOM" ></a>
				<%
						}
					
					%>
					<br><br>
		<button class='buy' type="submit" formaction="mywish.jsp">Buy now</button>
		
					<%
					  out.print("<input class='add2cart' name=\"goto\" type=\"submit\" value=\"Add to cart\">");
					out.print("</form>");
